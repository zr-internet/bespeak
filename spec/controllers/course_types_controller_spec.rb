...
describe CourseTypesController do
  ...
  describe "GET index" do
    it "assigns all course_types as @course_types" do
      ...
      assigns(:course_types).should eq([course_type])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested course_type as @course_type" do
      ...
      assigns(:course_type).should eq(course_type)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new course_type as @course_type" do
      ...
      assigns(:course_type).should be_a_new(CourseType)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created course_type as @course_type" do
        post :create, {:course_type => valid_attributes}, valid_session
        assigns(:course_type).should be_a(CourseType)
        assigns(:course_type).should be_persisted
      end

      it "redirects to the created course_type" do
        post :create, {:course_type => valid_attributes}, valid_session
        response.should redirect_to(CourseType.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved course_type as @course_type" do
        ...
        CourseType.any_instance.stub(:save).and_return(false)
        post :create, {:course_type => { "name" => "invalid value" }}, valid_session
        assigns(:course_type).should be_a_new(CourseType)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested course_type" do
        course_type = CourseType.create! valid_attributes
        # Assuming there are no other course_types in the database, this
        # specifies that the CourseType created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        CourseType.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => course_type.to_param, :course_type => { "name" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the course_type" do
        course_type = CourseType.create! valid_attributes
        put :update, {:id => course_type.to_param, :course_type => valid_attributes}, valid_session
        response.should redirect_to(course_type)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the course_type as @course_type" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        CourseType.any_instance.stub(:save).and_return(false)
        put :update, {:id => course_type.to_param, :course_type => { "name" => "invalid value" }}, valid_session
        assigns(:course_type).should eq(course_type)
      end
